/*
 * @Author: Ccc 1169451697@qq.com
 * @Date: 2023-10-20 16:11:57
 * @LastEditors: Ccc 1169451697@qq.com
 * @LastEditTime: 2023-10-20 16:14:22
 * @FilePath: \vue3-draggable-float\vite.config.ts
...
export default defineConfig({
  ...
  build: {
    lib: { // 构建为库。如果指定了 build.lib，build.cssCodeSplit 会默认为 false。
      ...
      name: 'Vue3DraggableFloat', // 暴露的全局变量
      fileName: 'vue3-draggable-float' // 输出的包文件名，默认是package.json的name选项
    },
